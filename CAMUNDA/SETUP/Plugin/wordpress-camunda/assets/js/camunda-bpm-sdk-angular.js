!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.CamSDK=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
  ...
  },{"./../../forms/camunda-form":37,"./../../forms/constants":38,"moment":60}],2:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./../../forms/type-util":48,"./camunda-form-angular":1}],3:[function(_dereq_,module,exports){
  /** @namespace CamSDK */
  ...
  },{"./../api-client":7,"./../utils":50,"./forms":2}],4:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./../base-class":35,"./../events":36,"q":62}],5:[function(_dereq_,module,exports){
  ...
  },{"./../events":36,"./../utils":50,"buffer":52,"q":62,"superagent":64}],7:[function(_dereq_,module,exports){
  'use strict';
  var Events = _dereq_('./../events');
  ...
  */
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],12:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],13:[function(_dereq_,module,exports){
  'use strict';
  ...
  */
  ...
  },{"../../utils":50,"../abstract-client-resource":4}],16:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],17:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],20:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./../abstract-client-resource":4,"q":62}],29:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],30:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4,"q":62}],32:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4}],33:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../../utils":50,"./../abstract-client-resource":4,"q":62}],34:[function(_dereq_,module,exports){
  'use strict';
  ...
  var SelectFieldHandler = _dereq_('./controls/select-field-handler');
  
  var ButtonFieldHandler = _dereq_('./controls/button-field-handler');
  
  var TableFieldHandler = _dereq_('./controls/table-field-handler');
  
  var ParagraphFieldHandler = _dereq_('./controls/paragraph-field-handler');
  ...
  CamundaForm.prototype.storeOriginalValues = function(variables) {
    for(var v in variables) {
      ...
      this.formElement.scope()[v]=this.variableManager.variableValue(v);
    }
  };
  ...
  CamundaForm.fields.SelectFieldHandler = SelectFieldHandler;
  CamundaForm.fields.ButtonFieldHandler = ButtonFieldHandler;
  CamundaForm.fields.ParagraphFieldHandler = ParagraphFieldHandler;
  ...
  },{"./../base-class":35,"./../events":36,"./constants":38,"./controls/button-field-handler":40,"./controls/choices-field-handler":41,"./controls/file-download-handler":42,"./controls/input-field-handler":43,"./controls/paragraph-field-handler":44,"./controls/select-field-handler":45,"./controls/table-field-handler":46,"./dom-lib":47,"./variable-manager":49,"moment":60}],38:[function(_dereq_,module,exports){
  'use strict';
  ...
  module.exports = {
    ...
    DIRECTIVE_CAM_VALUE : 'cam-value',
    DIRECTIVE_CAM_TEXT : 'cam-text'
  };
  ...
  },{"../../base-class":35,"./../dom-lib":47}],40:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../constants":38,"./abstract-form-field":39}],41:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./../constants":38,"./../dom-lib":47,"./abstract-form-field":39}],42:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../type-util":48,"./../constants":38,"./abstract-form-field":39}],44:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../constants":38,"./abstract-form-field":39}],45:[function(_dereq_,module,exports){
  'use strict';
   ...
   * @augments {CamSDK.form.AbstractFormField}
   */
  var SelectFieldHandler = AbstractFormField.extend(
  /** @lends CamSDK.form.SelectFieldHandler.prototype */
    {
    /**
     * Prepares an instance
      ...
      // if cam-choices variable is defined, apply options
        ...
        if(this.choicesVariableName) {
          ...
          // array
            ...
            if(camText)
            {
              camText=camText.replace(/{/g, '{{item.');
              camText=camText.replace(/}/g, '}}');
            }
            if (choicesVariableValue instanceof Array) {
              for(var i = 0; i < choicesVariableValue.length; i++) {
                var val = choicesVariableValue[i];
                ...
                if(!this.element.find('option[value="'+val+'"]').length) {
                  this.element.append($('<option>', {
                    value: value,
                    text: text
                  }));
  ...
  },{"../constants":38,"../dom-lib":47,"./abstract-form-field":39}],46:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"../constants":38,"./abstract-form-field":39}],47:[function(_dereq_,module,exports){
  (function (global){
  'use strict';
  ...
  },{"fast-xml-parser":54}],49:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./type-util":48,"moment":60}],50:[function(_dereq_,module,exports){
  'use strict';
  ...
  },{"./forms/type-util":48}],51:[function(_dereq_,module,exports){
  ...
  },{"base64-js":51,"ieee754":58,"is-array":59}],53:[function(_dereq_,module,exports){
  ...
  },{"./util":55,"./validator":56,"he":57}],55:[function(_dereq_,module,exports){
  ...
  },{"./util":55}],57:[function(_dereq_,module,exports){
  (function (global){
  ...
  },{"v3go1D":61}],63:[function(_dereq_,module,exports){
