...
var comField = require('./ComboboxEntryFactory');
EntryFactory.comboBoxField = function (options) {
  return comField(options, setDefaultParameters(options));
};
var button = require('./ButtonEntryFactory');
EntryFactory.button = function (options) {
  return button(options, setDefaultParameters(options));
};
...
var comboTable = require('./ComboTableFactory');
EntryFactory.comboTable = function (options) {
  return comboTable(options);
};

var customTable = require('./CustomTableEntryFactory');
EntryFactory.customTable = function (options) {
  return customTable(options);
}

var customParamer = require('./CustomParameterFactory');
EntryFactory.customParamer = function (options) {
  return customParamer(options);
}
