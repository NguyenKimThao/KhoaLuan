...
var connectionProps = require('./parts/ConnectionProps');
function createConnectionTabGroups(element, bpmnFactory, elementRegistry, translat) {
  ...
  connectionProps(connectionGroup, element,bpmnFactory,translat);
...
var dataAssociationProps= require('./parts/DataAssociationProps');
function createDataTabGroups(element, bpmnFactory, elementRegistry, translat) {
  ...
  // Add the spell props to the black magic group.
  dataAssociationProps(dataGroup, element, bpmnFactory, translat);
...
function createServiceTabGroups(element, bpmnFactory, elementRegistry, translat) {
  ...
  // Add the spell props to the black magic group.
  serviceProps(serviceGroup, element, bpmnFactory, translat);
...
function CamundaPropertiesProvider(eventBus, bpmnFactory, elementRegistry, elementTemplates, translate) {
  ...
  this.getTabs = function(element) {
    ...
    var serviceTab={
      id: 'service',
      label: 'Service',
      groups: createServiceTabGroups(element,bpmnFactory,elementRegistry,translate)
    }
