...
function isFormItemChoices(attr) {
  return attr == 'Select'
    || attr == 'Table' || attr == 'Paragraph'
}
function isFormItemNoType(attr) {
  return attr == 'Button'
    || attr == 'UploadFile' || attr == 'LoadImage'||attr=='Link'
}
/**
...
module.exports = function (group, element, bpmnFactory, translate) {
  ...
  function getSelectedFormField(element, node) {
   ...
   //[FormTypeSubmit] form key text input field
  group.entries.push(entryFactory.comboBox({
    id: 'form-type-submit',
    label: translate('Form Type Submit'),
    selectOptions: [{ name: 'Normal', value: 'normal' }, { name: 'Auto', value: 'auto' }, { name: 'Button', value: 'button' }],
    modelProperty: 'typeSubmit',
    emptyParameter: true,

    get: function (element, node) {
      var bo = getBusinessObject(element);
      return {
        typeSubmit: bo.get('camunda:typeSubmit')
      };
    },
    set: function (element, values, node) {
      var bo = getBusinessObject(element),
      typeSubmit = values.typeSubmit;

  return cmdHelper.updateBusinessObject(element, bo, { 'camunda:typeSubmit': typeSubmit });
    }
  }));
  ...
  group.entries.push(entryFactory.comboBox({
    ...
    hidden: function (element, node) {
      var selectedFormField=getSelectedFormField(element, node);
      return !selectedFormField||isFormItemNoType( selectedFormField.$attrs.formItem);
    }
  }));
  ...
  group.entries.push(entryFactory.comboBox({
    ...
    get: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);
      if (selectedFormField) {
        return { formItem: selectedFormField.$attrs.formItem };
      } else {
        return {};
      }
    },
  ...
  // [FormData] form field formItemValue
  group.entries.push(entryFactory.textField({
    id: 'form-field-button-action',
    label: translate('Button Action'),
    modelProperty: 'buttonAction',

    get: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);

      if (selectedFormField) {
        return { buttonAction: selectedFormField.$attrs.buttonAction };
      } else {
        return {};
      }
    },
    ...
    hidden: function (element, node) {
       var selectedFormField = getSelectedFormField(element, node);
      return !selectedFormField || !selectedFormField.$attrs.formItem|| selectedFormField.$attrs.formItem != 'Button';
    }
  }));

  // [FormData] form field formItemChoices combo box
  group.entries.push(entryFactory.textField({
    id: 'form-field-form-item-choices',
    label: translate('Form Item Choices'),
    modelProperty: 'formItemChoices',

    get: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);

      if (selectedFormField) {
        return { formItemChoices: selectedFormField.$attrs.formItemChoices };
      } else {
        return {};
      }
    },
    ...
    hidden: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);
      return !selectedFormField || !selectedFormField.$attrs.formItem || !(isFormItemChoices(selectedFormField.$attrs.formItem));
    },
    validate: function (element, values, node) {

      var selectedFormField = getSelectedFormField(element, node);
      if (selectedFormField && selectedFormField.$attrs.formItem && isFormItemChoices(selectedFormField.$attrs.formItem)) {
        var formItemChoices = values.formItemChoices;

        if (!formItemChoices || formItemChoices.trim() === '') {
          return { id: 'Form field id must not be empty' };
        }
      }
    }
  ...
  // [FormData] form field formItemValue
  group.entries.push(entryFactory.textField({
    id: 'form-field-form-item-value',
    label: translate('Form Item Choices Value'),
    modelProperty: 'formItemValue',

    get: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);

      if (selectedFormField) {
        return { formItemValue: selectedFormField.$attrs.formItemValue };
      } else {
        return {};
      }
    },
  ...
  // [FormData] form field formItemValue
  group.entries.push(entryFactory.textField({
    id: 'form-field-form-item-text',
    label: translate('Form Item Choices Text'),
    modelProperty: 'formItemText',

    get: function (element, node) {
      var selectedFormField = getSelectedFormField(element, node);

      if (selectedFormField) {
        return { formItemText: selectedFormField.$attrs.formItemText };
      } else {
        return {};
      }
    },
