...
public abstract class FormItemHandle implements FormItem {
	/* elements */
	...
	protected static final String PARAGRAPH_ELEMENT = "p";
	...
	protected static final String THEAD_ELEMENT = "thead";
	protected static final String TBODY_ELEMENT = "tbody";
	protected static final String TH_ELEMENT = "th";
	...
	protected void renderDatePicker(FormField formField, HtmlDocumentBuilder documentBuilder) {
		...
		// start input-group
		HtmlElementWriter inputGroupDivElement = new HtmlElementWriter(DIV_ELEMENT).attribute(CLASS_ATTRIBUTE,
				INPUT_GROUP_CLASS);
		...
		if (!isReadOnly) {
			...
			HtmlElementWriter buttonElement = new HtmlElementWriter(BUTTON_ELEMENT)
					.attribute(TYPE_ATTRIBUTE, BUTTON_BUTTON_TYPE).attribute(CLASS_ATTRIBUTE, BUTTON_DEFAULT_CLASS)
	...
	protected void addCommonFormFieldAttributes(FormField formField, HtmlElementWriter formControl) {
		...
		if (!formField.isBusinessKey()) {
			formControl.attribute(CAM_VARIABLE_TYPE_ATTRIBUTE, typeName).attribute(CAM_VARIABLE_NAME_ATTRIBUTE,
					formFieldId);
		} else {
