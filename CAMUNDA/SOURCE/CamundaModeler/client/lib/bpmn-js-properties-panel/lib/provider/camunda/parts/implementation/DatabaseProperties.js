...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  assign(options, {
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('kltn:DataStoreFields', {}, parent, bpmnFactory);
      ...
      var property = elementHelper.createElement('kltn:Field', propertyProps, properties, bpmnFactory);
      ...
      if (propertyValues.length === 1) {
        ...
        if (!isExtensionElements(parent)) {
          ...
          forEach(parent.values, function(value) {
            if (is(value, 'kltn:DataStoreFields')) {
  ...
  return factory.comboTable(options);
};
