...
final class WP_Process_Type {
	...
	public function set_props( $args ) {
		...
		if ( empty( $args['capabilities'] ) && null === $args['map_meta_cap'] && in_array( $args['capability_type'], array( 'post', 'page','process' ) ) ) {
		...
		$this->labels = get_process_type_labels( $this );
