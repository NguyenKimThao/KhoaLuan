...
/**
 * Get all kltn:ServiceField objects for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {Array<ModdleElement>} a list of kltn:ServiceField objects
 */
...
/**
 * Get all kltn:ServiceDataFields object for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {ModdleElement} a kltn:ServiceDataFields object
 */
...
/**
 * Get first kltn:ServiceDataFields object for a specific bpmn:ExtensionElements
 * business object.
 *
...
function getPropertiesElementInsideExtensionElements(extensionElements) {
  return find(extensionElements.values, function(elem) {
    return is(elem, 'kltn:ServiceDataFields');
  });
}
...
/**
 * Create a kltn:ServiceField entry using tableEntryFactory
 *
...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  assign(options, {
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('kltn:ServiceDataFields', {}, parent, bpmnFactory);
      ...
      var property = elementHelper.createElement('kltn:ServiceField', propertyProps, properties, bpmnFactory);
  ...
  return factory.customTable(options);
};
